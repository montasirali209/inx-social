...
OpenMontage worker. The worker installs OpenMontage pinned to commit
`08e2151fa02de28a5d6a312b3d575692bf147ad7` and applies the AGPL-covered
workflow/provider-registry changes published in `openmontage-worker/`.
...
import its Python modules into the application runtime. Pexels and Pixabay media
remain subject to their respective content licences and contributor rights;
