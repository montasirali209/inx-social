...
export type PlatformAnalytics = {
  ...
  provider?: { engine?: string; accountId?: string; postsWithMetrics?: number; feedPosts?: number; unverifiedFeedPosts?: number; periodPosts?: number; ownershipVerified?: boolean; metricsRequested?: boolean; metricSummary?: ProviderMetricSummary[]; cacheState?: 'fresh' | 'live' | 'stale' | 'refreshing' | 'partial' }
}
