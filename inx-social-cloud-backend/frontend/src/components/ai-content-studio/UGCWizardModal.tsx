        ...
        <main className="ugc-wizard-content">
          <div className="ugc-wizard-step" key={currentKey}>
            ...
            {currentKey === 'finish' && <>
              ...
              {!terminal.has(campaign.data?.status || '') && <div className="mt-5 rounded-2xl border border-brand-cyan/20 bg-brand-cyan/[.055] p-4"><strong className="block text-sm text-white">You can leave this window at any time.</strong><p className="mt-1 text-[10px] leading-4 text-text-muted">Your UGC keeps rendering in the background. If you stay here, progress and the finished videos will remain visible on this Finish screen.</p></div>}
