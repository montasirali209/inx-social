...
export function StudioSelect<T extends string | number>({
  ...
  return <div ref={rootRef} className="relative min-w-0">
    ...
    {open && <div role="listbox" className="absolute left-0 right-0 z-[130] mt-2 overflow-hidden rounded-[20px] border border-brand-cyan/25 bg-[linear-gradient(155deg,rgba(8,31,44,.99),rgba(2,13,21,.99))] p-1.5 shadow-[0_28px_90px_rgba(0,0,0,.58),0_0_40px_rgba(0,214,192,.06)] backdrop-blur-2xl">
