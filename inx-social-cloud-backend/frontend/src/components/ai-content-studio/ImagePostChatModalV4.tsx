...
export function ImagePostChatModal({ open, type, access, initialDraft, onClose, onSaved, onContinue, onToast }: {
  ...
  return createPortal(<div className="ai-studio-modal-backdrop fixed inset-0 z-[110] bg-[#01070d]/90 backdrop-blur-md"><div className="flex h-dvh items-end justify-center p-0 sm:items-center sm:p-4"><section aria-modal="true" className="ai-studio-modal-enter relative flex h-[100dvh] w-full max-w-[1560px] flex-col overflow-hidden border border-brand-cyan/25 bg-[linear-gradient(145deg,rgba(5,22,34,.995),rgba(2,12,22,.995))] shadow-[0_40px_160px_rgba(0,0,0,.78)] sm:h-[min(94dvh,960px)] sm:rounded-[28px]" role="dialog">
