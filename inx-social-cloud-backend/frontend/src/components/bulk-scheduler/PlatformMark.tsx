...
export function PlatformMark({ platform, className = '' }: { platform: Platform; className?: string }) {
  ...
  return (
    <span
      ...
      className={`inline-grid size-8 shrink-0 place-items-center rounded-full text-[11px] font-black tracking-[-0.04em] shadow-[0_6px_18px_rgba(0,0,0,0.28)] ${definition.className} ${className}`}
      role="img"
    >
      {definition.mark}
    </span>
