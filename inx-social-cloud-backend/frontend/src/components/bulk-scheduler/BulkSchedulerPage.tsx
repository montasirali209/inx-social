...
export function BulkSchedulerPage() {
  ...
  return (
    <div className="dashboard-canvas">
      ...
      {historyView && <BulkScheduleManager initialView={historyView} jobs={schedulerData.jobs} onClose={() => setHistoryView(null)} onRetryJobs={(jobs) => { void retryReviewJobs(jobs) }} timezone={schedulerData.settings.timezone} />}
