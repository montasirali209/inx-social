...
export function AudiencePulseCard({ platform, audience, growth, interactions, contentCount, days }: AudiencePulseProps) {
  if (audience === null && growth === null) {
    return <AnalyticsCard>
      <AnalyticsCardHeader description={`Live post-level ${platformLabels[platform]} analytics are available for this connection.`} title="Audience Pulse" />
  ...
  return <AnalyticsCard>
    <AnalyticsCardHeader description={`A live snapshot built from the ${platformLabels[platform]} metrics currently available for this connection.`} title="Audience Pulse" />
