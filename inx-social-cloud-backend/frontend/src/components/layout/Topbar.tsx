...
export function Topbar({ overview }: { overview?: StudioOverview }) {
  ...
  return (
    <header className={`sticky top-0 z-20 flex items-center justify-between gap-4 border-b border-border-soft bg-bg/88 px-4 shadow-[0_12px_40px_rgba(0,0,0,0.12)] backdrop-blur-2xl sm:px-6 ${dashboardRoute ? 'min-h-[78px]' : 'min-h-16'}`}>
