...
export function SelectedDatePanel({ date, posts, slots, selectedTime, bestTime, bestTimeLoading, onSelectTime }: { date: string; posts: CalendarPost[]; slots: AvailableSlot[]; selectedTime: string; bestTime: BestTimeInsight; bestTimeLoading: boolean; onSelectTime: (time: string) => void }) {
