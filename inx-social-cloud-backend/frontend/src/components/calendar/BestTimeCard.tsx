...
export function BestTimeCard() {
  return <section className="rounded-card border border-border-soft bg-panel/55 p-3.5">
    ...
    <a className="mt-3 inline-flex text-[10px] font-semibold text-brand-cyan hover:text-white focus-visible:outline-2 focus-visible:outline-brand-cyan" href="/studio/?view=analytics">Open live Analytics →</a>
  </section>
}
