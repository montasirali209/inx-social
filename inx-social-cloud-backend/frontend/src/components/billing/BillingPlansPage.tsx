...
export function BillingPlansPage() {
  ...
  return <div className="space-y-4 pb-10">
    ...
    <div className="grid gap-4 xl:grid-cols-12">
      {visible('current plan subscription upgrade manage') && <div className="xl:col-span-8"><CurrentPlanCard onManage={() => setPanel('subscription')} onUpgrade={showPlans} overview={data} /></div>}
      {visible('usage limits analytics ai scheduled connected pages') && <div className="xl:col-span-4"><UsageCard onView={() => setPanel('usage')} overview={data} /></div>}
    </div>
    <div className="grid gap-4 xl:grid-cols-12">
      {visible('billing information payment method stripe security') && <div className="xl:col-span-7"><BillingInformationCard onUpdate={() => void portal()} /></div>}
    ...
    <div className="grid gap-4 xl:grid-cols-12">
      ...
      {visible('secure billing stripe payment privacy') && <div className="xl:col-span-5"><SecureBillingFooter onLearn={() => setPanel('security')} /></div>}
    </div>
