...
import type { PublishProgress, ScheduleMode } from '../../types/posts'
...
export function SchedulePanel(props: Props) {
  ...
  return (
    <section className="interactive-surface rounded-panel border p-4 xl:p-5">
      ...
      <div className="mt-3 rounded-xl border border-brand-cyan/20 bg-brand-cyan/[0.045] p-3"><div className="flex items-center gap-2 text-xs font-semibold text-brand-cyan"><Clock3 className="size-4" />Best Time To Post</div><p className="mt-1 text-[10px] text-text-muted">Timing becomes personalised from the selected Page’s live engagement history.</p></div>
