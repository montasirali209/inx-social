...
export function WorkflowStepper({ summary }: { summary: JobSummary }) {
  ...
  return (
    <section aria-labelledby="workflow-heading" className="interactive-surface overflow-hidden rounded-panel border px-5 py-5 backdrop-blur-xl sm:px-6">
