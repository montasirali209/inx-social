  ...
  return (
    <section className="overflow-hidden rounded-card border border-brand-cyan/25 bg-[radial-gradient(circle_at_90%_10%,rgba(45,212,191,0.12),transparent_8rem),linear-gradient(145deg,rgba(20,184,166,0.1),rgba(7,25,35,0.96)_52%,rgba(16,185,129,0.05))] p-4 shadow-[0_16px_44px_rgba(0,0,0,.2)]">
      ...
      <ul className="mt-3 grid gap-2 text-[11px] text-text-muted">
        <li className="flex items-center gap-2"><Check aria-hidden="true" className="size-3.5 text-brand-teal" /> AI content generation</li>
        <li className="flex items-center gap-2"><Check aria-hidden="true" className="size-3.5 text-brand-teal" /> Advanced analytics</li>
        <li className="flex items-center gap-2"><Check aria-hidden="true" className="size-3.5 text-brand-teal" /> More connected accounts</li>
      </ul>
