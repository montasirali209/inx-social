...
const LEGACY_FEMALE_VOICES = new Set(['Pippa','Zephyr (Female)','Kore (Female)','Leda (Female)','Callirrhoe (Female)']);
...
const avatarSeeds = [
  ['Maya','Lifestyle','Pippa','25–34','en-GB','Pippa','warm British lifestyle creator, natural brown hair, contemporary casual clothing'],
  ['Sofia','Beauty','Sophie','25–34','en-GB','Pippa','polished beauty creator, dark hair, clean modern makeup, premium casual style'],
  ['Chloe','Fashion','Chloe','18–24','en-GB','Pippa','young fashion creator, expressive style, modern streetwear, natural social-video look'],
  ['Amelia','Home','Olivia','35–44','en-GB','Pippa','home and family creator, approachable, modern neutral wardrobe, warm interior setting'],
  ['Aisha','Wellness','Nadia','25–34','en-GB','Pippa','British wellness creator wearing modest contemporary fashion, calm confident presence'],
  ['Priya','Business','Priya','25–34','en-GB','Pippa','British South Asian professional creator, smart-casual wardrobe, confident friendly delivery'],
  ['Isla','Travel','Serena','25–34','en-GB','Pippa','travel creator, relaxed premium casual styling, lively friendly presence'],
  ['Grace','Food','Jessica','35–44','en-GB','Pippa','food and home creator, warm approachable appearance, natural kitchen-ready styling'],
  ['Nadia','Beauty','Nadia','25–34','en-GB','Pippa','beauty and lifestyle creator with modest elegant styling and expressive friendly face'],
  ['Ruby','Fitness','Chloe','18–24','en-GB','Pippa','fitness creator, athletic casual outfit, energetic authentic social-media presence'],
  ['Olivia','Luxury','Olivia','35–44','en-GB','Pippa','premium lifestyle creator, elegant understated wardrobe, sophisticated natural presence'],
  ['Emily','Parenting','Pippa','35–44','en-GB','Pippa','friendly parent creator, practical contemporary clothing, believable everyday appearance'],
  ['Zara','Tech','Sophie','25–34','en-GB','Pippa','tech creator, minimalist smart-casual styling, modern home-office presence'],
  ['Hannah','Education','Serena','25–34','en-GB','Pippa','educational creator, clear friendly professional look, simple smart-casual wardrobe'],
  ['Layla','Ecommerce','Priya','25–34','en-GB','Pippa','ecommerce creator, contemporary stylish appearance, energetic product-review presence'],
  ['Megan','Lifestyle','Olivia','45–54','en-GB','Pippa','mature lifestyle creator, confident approachable appearance, elegant casual styling'],
  ['Claire','Home','Claire','55–64','en-GB','Pippa','mature home creator, warm trustworthy appearance, natural polished casual wardrobe'],
  ['Diana','Wellness','Sophie','65+','en-GB','Pippa','senior wellness creator, warm trustworthy face, elegant everyday styling'],
  ['Jasmine','Fashion','Jessica','25–34','en-US','Pippa','American fashion creator, polished street style, authentic mobile-video presence'],
  ['Ava','Beauty','Chloe','18–24','en-US','Pippa','American beauty creator, youthful natural makeup, creator-native casual styling'],
  ['Camila','Lifestyle','Serena','25–34','en-US','Pippa','Latina lifestyle creator, vibrant approachable presence, modern casual wardrobe'],
  ['Elena','Fitness','Nadia','25–34','en-US','Pippa','fitness and wellness creator, athletic styling, confident natural presence'],
  ['Rachel','Business','Olivia','35–44','en-US','Pippa','American business creator, smart casual, credible founder-style presence'],
  ['Monica','Home','Pippa','45–54','en-US','Pippa','American home and lifestyle creator, warm mature presence, authentic everyday look'],
  ['Keisha','Beauty','Nadia','25–34','en-US','Pippa','Black American beauty creator, natural polished look, confident warm delivery'],
  ['Jordan','Tech','Riley','25–34','en-US','Puck (Male)','modern tech creator, gender-neutral contemporary style, confident friendly presence'],
  ['Daniel','Tech','Callum','25–34','en-GB','Puck (Male)','British tech creator, modern smart-casual outfit, trustworthy approachable presence'],
  ['James','Business','James','35–44','en-GB','Puck (Male)','British business creator, founder-style smart casual wardrobe, calm confident appearance'],
  ['Oliver','Lifestyle','Oliver','25–34','en-GB','Puck (Male)','British lifestyle creator, relaxed contemporary clothing, natural social-video presence'],
  ['Noah','Fitness','Ethan','18–24','en-GB','Puck (Male)','young fitness creator, athletic styling, energetic authentic presence'],
  ['Adam','Ecommerce','Shaun','25–34','en-GB','Puck (Male)','ecommerce product reviewer, casual modern styling, energetic credible presence'],
  ['Yusuf','Business','Graham','35–44','en-GB','Puck (Male)','British Muslim professional creator, polished smart-casual styling, calm trustworthy presence'],
  ['Arjun','Tech','Arjun','25–34','en-GB','Puck (Male)','British South Asian tech creator, modern casual wardrobe, articulate friendly presence'],
  ['Leo','Fashion','Oliver','25–34','en-GB','Puck (Male)','menswear creator, stylish contemporary outfit, confident creator-native look'],
  ['George','Home','Graham','45–54','en-GB','Puck (Male)','mature home and DIY creator, practical casual clothing, trustworthy approachable look'],
  ['Peter','Finance','James','55–64','en-GB','Puck (Male)','mature finance and business creator, polished understated styling, credible presence'],
  ['Thomas','Lifestyle','Callum','65+','en-GB','Puck (Male)','senior lifestyle creator, warm trustworthy appearance, classic casual wardrobe'],
  ['Marcus','Fitness','Marcus','25–34','en-US','Puck (Male)','Black American fitness creator, athletic contemporary style, energetic natural presence'],
  ['Ethan','Tech','Ethan','25–34','en-US','Puck (Male)','American tech creator, clean casual style, modern desk-setup presence'],
  ['Carlos','Food','Marcus','35–44','en-US','Puck (Male)','Latino food creator, warm expressive face, casual kitchen-ready styling'],
  ['Ryan','Gaming','Ethan','18–24','en-US','Puck (Male)','young gaming creator, modern streetwear, energetic authentic online presence'],
  ['Michael','Business','James','35–44','en-US','Puck (Male)','American founder-style creator, smart casual, polished credible appearance'],
  ['David','Home','Graham','45–54','en-US','Puck (Male)','American home and DIY creator, approachable mature look, practical casual styling'],
  ['Kenji','Tech','Oliver','25–34','en-US','Puck (Male)','East Asian tech creator, minimalist contemporary styling, calm confident presence'],
  ['Mei','Beauty','Sophie','25–34','en-US','Pippa','East Asian beauty creator, refined natural makeup, modern creator-native styling'],
  ['Fatima','Lifestyle','Nadia','35–44','en-GB','Pippa','British modest-fashion lifestyle creator, elegant approachable styling, warm presence'],
  ['Samira','Food','Priya','25–34','en-GB','Pippa','food and lifestyle creator, warm expressive presence, contemporary modest styling'],
  ['Theo','Travel','Callum','25–34','en-GB','Puck (Male)','travel and outdoor creator, relaxed contemporary wardrobe, adventurous natural presence'],
  ['Ben','Automotive','Shaun','35–44','en-GB','Puck (Male)','automotive creator, clean casual outfit, credible enthusiast presence'],
  ['Lily','Pets','Pippa','25–34','en-GB','Pippa','pet and lifestyle creator, friendly playful presence, natural everyday styling'],
  ['Alex','SaaS','Callum','25–34','en-GB','Puck (Male)','SaaS and productivity creator, modern home-office style, confident conversational presence'],
  ['Emma','SaaS','Sophie','25–34','en-GB','Pippa','SaaS and productivity creator, polished modern office-casual style, clear friendly presence']
].map((row, index) => ({
...
async function renderProviderScene(scene, ad, avatar, brandReference, narration, onProgress) {
  ...
  if (scene.route === 'AVATAR') {
    ...
    Object.assign(base, {
      ...
      ...(narration ? {} : { speech: { text: clean(scene.script || ad.script, 6000), voice: narratorVoice(ad.voice || avatar.voice, avatar), language: clean(avatar.locale || 'en-GB', 20) } }),
